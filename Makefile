.PHONY: tf-init tf-apply kube ansible-ingress ansible-issuers ansible-rancher ansible-argocd ansible-all
.RECIPEPREFIX := >
...
ansible-all: ansible-ingress ansible-issuers ansible-rancher ansible-argocd
